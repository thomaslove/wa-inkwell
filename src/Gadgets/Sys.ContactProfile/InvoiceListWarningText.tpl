...
<div class="buttons" id="payButtonsMessageBoxGroup" style="display:none">
        <$if (Model.InvoiceAndPaymentList.DisplayPaymentProcessingFeeDonationCheckBoxBool)$>
          <div id="paymentProcessingFeeDonationPlaceHolder"> 
            <div class="cww"></div> 
            <div class="cww"></div> 
            <div class="cww"></div> 
            <div>  
               <input type="checkbox" id="paymentProcessingFeeDonation" name="paymentProcessingFeeDonation" />
               <label for="paymentProcessingFeeDonation" id="paymentProcessingFeeDonationLabel"></label> 
            </div>
            <div class="ppfdExcluding"><$Model.InvoiceAndPaymentList.PaymentProcessingFeeDonationExcludingMessage$></div>
            <div class="cww"></div> 
            <div class="cww"></div> 
            <div class="cww"></div> 
          </div> 
