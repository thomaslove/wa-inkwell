			...
			<div class="formContainer">
				<div class="generalFieldsContainer">
					...
					<$control.FormHelpers (sectionStart="true")$>
						...
						<$if (Model.DonationDetails.ShowPaymentProcessingFeeDonation)$>
    							<div class="fieldContainer simpleTextContainer">
								<div class="fieldSubContainer labeledTextContainer">
									<div class="fieldLabel">
										<span>
											<$Model.DonationDetails.Text.PaymentProcessingFeeDonationLabel$>
										</span>
									</div>
									<div class="fieldBody">
										<a href="<$Model.DonationDetails.PaymentProcessingFeeDonationUrl$>">
										        <$Model.DonationDetails.Text.PaymentDetailsLabel$>
										</a>
									</div>
								</div>
							</div>
