			...
			<div class="formContainer">
				<div class="generalFieldsContainer">
					...
					<$control.FormHelpers (sectionStart="true")$>
						...
						<$endif$>
						<$if (Model.PaymentDetails.ShowPaymentProcessingFeeDonation)$>
    							<div class="fieldContainer simpleTextContainer">
								<div class="fieldSubContainer labeledTextContainer">
									<div class="fieldLabel">
										<span>
											<$Model.PaymentDetails.Text.PaymentProcessingFeeDonationLabel$>
										</span>
									</div>
									<div class="fieldBody">
										<a href="<$Model.PaymentDetails.PaymentProcessingFeeDonationUrl$>">
										      <$Model.PaymentDetails.PaymentProcessingFeeDonationLink$>
										</a>
									</div>
								</div>
							</div>
