      ...
      jq$(function()
      {
        ...
        var layout = new WaOnlineStoreCheckoutLayout(serviceCheckout, cartService,
        {
              initModel: {
                ...
                paymentProcessingFeeDonationPercent: <$Model.PaymentProcessingFeeDonationPercent$>,
                paymentProcessingFeeDonationIncrease: <$Model.PaymentProcessingFeeDonationIncrease$>,
              },
    ...
    <div class="pagesContainer">
      ...
      <div class="storeCartContent" id="step-3">
        ...
        <form class="standardForm" name="order_details" action="" method="post">
            ...
            <$if(Model.DisplayPaymentProcessingFeeDonationCheckBox)$>
                <div id="paymentProcessingFeeDonation">
                    <h2>Payment processing fee donation</h2>
                    <div class="formFieldContainer">
                        <div class="formField">
                            <input type="checkbox" id="paymentProcessingFeeDonationCheckBox" name="paymentProcessingFeeDonation"/>
                            <label for="paymentProcessingFeeDonationCheckBox">
                                I'll generously add a donation of <span id="paymentProcessingFeeDonationAmount"></span> to my total <b>online payment</b> to cover payment processing fees.
                            </label> 
                        </div>
                    </div>
                </div>     
